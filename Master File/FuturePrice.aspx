<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FuturePrice.aspx.vb" Inherits="IM_POM_VB.Net.FuturePrice" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Future Selling Price</title>
...
<body>
    <form id="frmFurturePrice" runat="server" >
        <center>
           ...
           <asp:Label ID="lblFP" runat="server" CssClass="text-white h5" Text="Future Price"></asp:Label>
          
       </div>
        <div class="container alert alert-danger d-flex justify-content-center" id="alertError" runat="server" visible="false">
             <asp:Label ID="lblError" runat="server" CssClass="text-dark"></asp:Label>
        </div>
        ...
        <div class="w-50">
            ...
            <tr>
                <td>
                    <table class="entry" id="tblDetail1" runat="server">
